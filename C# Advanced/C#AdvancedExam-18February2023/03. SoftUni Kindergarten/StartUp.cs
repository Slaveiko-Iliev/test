...
namespace SoftUniKindergarten
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            Child childTwo = new Child("Elona", "Muskova", 4, "Maye Musk", " 1 888 518 3752"); Child childThree = new Child("George", "Bush", 5, " George Bush Sr.", "xx xxx xxx xxx");
            ...
            // True 
            Console.WriteLine(kindergarten.AddChild(childThree));   // True 
            Console.WriteLine(kindergarten.AddChild(childFour));    // True 
            Console.WriteLine(kindergarten.AddChild(childFive));    // True 
            Console.WriteLine(kindergarten.AddChild(childSix));     // True 
            Console.WriteLine(kindergarten.AddChild(childSeven));   // True 
            Console.WriteLine(kindergarten.AddChild(childEight));   // True 
            Console.WriteLine(kindergarten.AddChild(childNine));    // False 
            
            Console.WriteLine(kindergarten.RemoveChild("Ruzha Ignatova"));   // True
            Console.WriteLine(kindergarten.RemoveChild("George Bush"));   // True 
            Console.WriteLine(kindergarten.RemoveChild("Elona Muskova"));   // True 

            Console.WriteLine(kindergarten.RemoveChild("Ruzha Ignatova"));   // False 
            Console.WriteLine(kindergarten.RemoveChild("Tim Duncan"));   // False 
